...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userType: from_candid_variant_n14(_uploadFile, _downloadFile, value.userType),
...
function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userType: to_candid_variant_n19(_uploadFile, _downloadFile, value.userType),
        contactInfo: value.contactInfo,
        name: value.name
    };
}
...
function to_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_taker_provider_both_none): {
    taker: null;
} | {
    provider: null;
} | {

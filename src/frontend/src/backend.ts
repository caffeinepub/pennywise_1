...
export class Backend implements backendInterface {
    ...
    async addDocument(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addProvider(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addRating(arg0: Principal, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async completeBooking(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async findProvidersByService(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.findProvidersByService(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBookings(): Promise<Array<[string, Booking]>> {
        if (this.processError) {
            try {
    ...
    async getBookingsForProvider(): Promise<Array<[string, Booking]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingsForProvider();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBookingsForTaker(): Promise<Array<[string, Booking]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingsForTaker();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProviderAvailabilities(): Promise<Array<ProviderAvailability>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProviderAvailabilities();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProviderAvailability(arg0: Principal): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProviderAvailability(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProviders(): Promise<Array<ServiceProvider>> {
        if (this.processError) {
            try {
    ...
    async makeBooking(arg0: string, arg1: Time, arg2: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.makeBooking(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerTaker(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerTaker(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userType: from_candid_variant_n15(_uploadFile, _downloadFile, value.userType),
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    none: null;
}): Variant_taker_provider_both_none {
    return "taker" in value ? Variant_taker_provider_both_none.taker : "provider" in value ? Variant_taker_provider_both_none.provider : "both" in value ? Variant_taker_provider_both_none.both : "none" in value ? Variant_taker_provider_both_none.none : value;
}
...
function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userType: to_candid_variant_n21(_uploadFile, _downloadFile, value.userType),
        contactInfo: value.contactInfo,
        name: value.name
    };
}
...
function to_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_taker_provider_both_none): {
    taker: null;
} | {
    provider: null;
} | {
    ...
    return value == Variant_taker_provider_both_none.taker ? {
        taker: null
    } : value == Variant_taker_provider_both_none.provider ? {
        provider: null
    } : value == Variant_taker_provider_both_none.both ? {
        both: null
    } : value == Variant_taker_provider_both_none.none ? {
        none: null
    } : value;
}
